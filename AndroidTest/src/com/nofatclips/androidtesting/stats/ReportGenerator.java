...
//		return "Traces processed: " + this.traceReport.getTraces() + NEW_LINE + 
//				TAB + "success: " + this.traceReport.getTracesSuccessful() + NEW_LINE + 
//				TAB + "fail: " + this.traceReport.getTracesFailed() + NEW_LINE + 
//				TAB + "crash: " + this.traceReport.getTracesCrashed() + NEW_LINE +
//				"Non repeatable issues:" + this.traceReport.getTracesAsync() + NEW_LINE +
		return this.traceReport + NEW_LINE +
				...
				BREAK +
				this.eventReport +
//				"Interactions: " + this.eventReport.getInteractionCount() + NEW_LINE +
//				TAB + "different interactions: " + this.eventReport.getDifferentInteractions() + NEW_LINE +
//				TAB + "events: " + this.eventReport.getEventCount() + NEW_LINE +
//				TAB + "different events: " + this.eventReport.getDifferentEvents() + NEW_LINE +
//				TAB + "inputs: " + this.eventReport.getInputCount() + NEW_LINE +
//				TAB + "different inputs: " + this.eventReport.getDifferentInputs() + 
				BREAK + 
